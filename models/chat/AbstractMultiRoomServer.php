...
use app\models\chat\Exception\ConnectedClientNotFoundException;
use app\models\chat\Exception\InvalidActionException;
use app\models\chat\Exception\MissingActionException;
...
abstract class AbstractMultiRoomServer implements MessageComponentInterface
{
    ...
    public function onMessage(ConnectionInterface $conn, $msg)
    {
        ...
        echo "Packet received: ".count($this->clients).PHP_EOL;
